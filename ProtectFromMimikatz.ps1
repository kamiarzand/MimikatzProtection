...
$confirm = [System.Windows.Forms.MessageBox]::Show("Running this program requires restarting the computer. are you agree to run it??","Anti Mimikatz", "YesNo" , "Information" , "Button1")

if([string]$confirm -eq "Yes"){
     Revoke-UserRight -Account "BUILTIN\Administrators" -Right SeDebugPrivilege
